...
AccountsDto accountsDtoFromMap(String str) => AccountsDto.fromMap(json.decode(str));
...
class AccountsDto {
    ...
    List<AccountResponse> data;
      factory AccountsDto.fromJson(String str) => AccountsDto.fromMap(json.decode(str));

    factory AccountsDto.fromMap(Map<String, dynamic> json) => AccountsDto(
        message: json["message"],
        status: json["status"],
        data: List<AccountResponse>.from(json["data"].map((x) => AccountResponse.fromMap(x))),
    );
